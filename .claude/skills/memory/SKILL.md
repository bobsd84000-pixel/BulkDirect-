---
name: memory
description: Mémoire persistante hiérarchique dans ~/.claude/memory/ — core.md, me.md, topics/, projects/. Utiliser pour sauvegarder et rappeler du contexte entre sessions.
---
